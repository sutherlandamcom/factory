...
function validBriefTask() {
  return {
    type: "create_page",
    siteId: "sutherland-private-office",
    page: {
      type: "general",
      slug: "/chamonix-market-intelligence",
      title: "Chamonix market intelligence for property decisions",
      description: "Evidence-led Chamonix property market context for buyers.",
      sections: ["hero", "content_section", "faq"],
      contentBrief: {
        purpose: "Provide dated, source-backed market context.",
        audience: "International buyers evaluating Chamonix assets.",
        sourceBlueprintRunId: "20260901T114820Z-8976f5e5",
        sections: [
          {
            sectionType: "hero",
            heading: "Chamonix market intelligence",
            keyPoints: ["Chamonix is a deep second-home market."],
            prohibitedClaims: ["Do not infer asset value from resort averages."],
          },
          {
            sectionType: "content_section",
            heading: "Evidence before conclusions",
            keyPoints: ["Transaction data does not resolve condition or legal constraints."],
          },
          {
            sectionType: "faq",
            heading: "Chamonix questions",
            keyPoints: ["What should a buyer verify next?"],
          },
        ],
        internalLinks: [{ targetSlug: "/megeve-market-intelligence", purpose: "Compare markets." }],
      },
    },
  } as const;
}
...
test("valid contentBrief parses and is preserved", () => {
  ...
  assert.equal(parsed.page.contentBrief.internalLinks?.[0]?.targetSlug, "/megeve-market-intelligence");
});
