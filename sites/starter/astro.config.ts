...
/**
 * Minimal static crawler-discovery output (PROVEN launch requirement,
 * deliberately NOT an SEO subsystem): after the static build, emit a sitemap
 * over every generated HTML route and a robots.txt pointing at it. URLs derive
 * from the same validated canonical origin the site and QA use, so they can
 * never disagree with canonical/OG metadata.
 */
